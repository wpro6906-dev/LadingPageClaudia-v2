...
export function IdentityManager() {
  ...
  const [form, setForm] = useState({
    ...
    tagline1Color: "#FBF5EA",
    tagline2Color: "#F6D68A",
  ...
  useEffect(() => {
    if (profile) {
      ...
      setForm(prev => ({
        ...
        lastNameColor: vc.lastNameColor ?? "#F6D68A",
        ...
        subtitleColor: vc.subtitleColor ?? "#FDF8ED",
        ...
        tagline1Color: vc.tagline1Color ?? "#FBF5EA",
        tagline2Color: vc.tagline2Color ?? "#F6D68A",
